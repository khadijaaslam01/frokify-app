...
// the function and modules are placed here that we have to use over and over again
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class View {
    ...
    renderMessahe(message = this._message) {
        const markup = `
      <div class="message">
              <div>
                <svg>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aD7Zm","aenu9"], "aenu9", "parcelRequire9d59")
